...
<div class="project-info">
    <table>
        <tbody>
        <tr><th class="project-info-heading">Project Information</th><div class="m-btn green"><?php print l('Edit', "islandora/edit_form/{$variables['islandora_object']->id}/MADS");?></div></tr>
